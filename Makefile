...
lint:
	PYTHONPATH=$PYTHONPATH:.venv:. ; . .venv/bin/activate && flake8 graphene-custom-directives tests
...
coverage:
	PYTHONPATH=$PYTHONPATH:.venv:. ; . .venv/bin/activate && coverage run --source graphene-custom-directives setup.py test
...
docs:
	rm -f docs/graphene-custom-directives.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ graphene-custom-directives
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
